...
//             ),
//             RatingBar(
//               rating: _takeAway ? track.store != null ? track.store!.avgRating : 0 : track.deliveryMan!.avgRating, size: 10,
//               ratingCount: _takeAway ? track.store != null ? track.store!.ratingCount : 0 : track.deliveryMan!.ratingCount,
//             ),
//           ])),
//           InkWell(
//             onTap: () async {
