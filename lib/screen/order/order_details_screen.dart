...
//   void initState() {
//     super.initState();
//     checkDiscount(widget.orderId.toString());
//
...
//   }
//
//   Future<void> checkDiscount(String orderId) async {
...
//         .get();
//     final transactions =
//         response.docs != null ? response.docs.first.data() : null;
//     if (transactions != null) {
//       setState(() {
//         if (transactions.typeTransaction == "discount") {
//           discount = transactions.amount!;
//         }
//       });
//     }
//   }
...
//             _discount = _order.storeDiscountAmount! + discount;
...
//                                     //   child: Center(
//                                     //     child: Expanded(
//                                     //       child: Text(_order.orderType!.tr,
//                                     //           style: robotoMedium),
//                                     //     ),
//                                     //   ),
//                                     // ),
...
//                       }
//                     });
//                     if(order.delivered != null && order.id != null){
