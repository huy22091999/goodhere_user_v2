...
import '../screen/location/widget/module_dialog.dart';
import '../screen/location/widget/permission_dialog.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  AddressModel? _addressUserModel;

  AddressModel? get addressUserModel => _addressUserModel;
  ...
  //       latitude: defaultLatLng != null ? defaultLatLng.latitude : double.parse("12.454"),
  //       longitude: defaultLatLng != null ? defaultLatLng.longitude : double.parse("12.454"),
  ...
  void setAddressUserModel(AddressModel addressModel) {
    _addressUserModel = addressModel ;
  }
